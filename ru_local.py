...
TEXT_1 = ('Все добрались до убежища за секунду до взрыва! УРА! Вам повезло! '
          '\nСначала вы все паниковали, потом ссорились, теперь все молчат. За последние часы ни слова.'
...
TEXT_21_YES = ('Когда была поднята трубка, то стал слышен вздох облегчения с другой стороны. Человек представился '
                'уцелевшим из соседнего городка, и тут связь оборвалась. Радиация в окрестностях ещё слишком высокая. ')
TEXT_21_NO = 'Вы правильно сделали, что не пошли. Радиация сейчас очень высокая. '
# day 3
...
TEXT_4_1_1 = 'Использовать радиоприёмник вости!'
TEXT_4_1_2 = 'Ничего не делать'
