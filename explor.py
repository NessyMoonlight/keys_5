...
def event2():
    ...
    btn4 = Button(frame_bottom1, text="Выбор 3", bg="brown", command=end4)
    btn4.pack(side=LEFT)

    btn5 = Button(frame_bottom1, text="Выбор 4", bg="brown", command=end5)
    btn5.pack(side=LEFT)

    btn6 = Button(frame_bottom1, text="Выбор 5", bg="brown", command=end6)
    btn6.pack(side=LEFT)
